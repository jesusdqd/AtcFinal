...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/areas/matematicas/mtc.css') }}">
        ...
        <ul class="nav-links">
            ...
            <div class="right-links">
                ...
                <li><a href="/Html/Navbar/Juegos/juegos.html">
                    <img src="/Assets/Iconos/Barra_Navegacion/Mando.png" alt="Icono de Juegos" style="margin-right: 20px;">Juegos</a></li>
                <li><a href="/Html/Navbar/Examen/examen.html">
                    <img src="/Assets/Iconos/Barra_Navegacion/Examen.png" alt="Icono de Exámenes" style="margin-right: 20px;">Exámenes</a></li>    
            </div>
        </ul>
    </nav>
