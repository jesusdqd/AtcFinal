...
<head>
    ...
    <title>Química</title>
    <link rel="stylesheet" href="{{ asset('css/areas/quimica/qmc.css') }}">
            ...
            <li class="dropdown">
                ...
                <div class="dropdown-content">
                    <a href="/ApruebaTuConocimiento/Html/Areas/Informatica/Informatica.html">
                        <img src="/Assets/Iconos/Areas/informatica.png" alt="Informatica"class="nav-icon">Informatica</a>
                    <a href="/ApruebaTuConocimiento/Html/Areas/Religion/Religion.html">
                        <img src="/Assets/Iconos/Areas/religion.png" alt="Religion"class="nav-icon">Religion</a>
                    ...
                    <a href="/ApruebaTuConocimiento/Html/Areas/Matematicas/matematicas.html">
                        <img src="/Assets/Iconos/Areas/matematicas.png" alt="Matematicas"class="nav-icon">Matematicas</a>
                    ...
                    <a href="/ApruebaTuConocimiento/Html/Areas/Politica/Politica.html">
                        <img src="/Assets/Iconos/Areas/politica.png" alt="Politica"class="nav-icon">Politica</a>
                </div>
            </li>
