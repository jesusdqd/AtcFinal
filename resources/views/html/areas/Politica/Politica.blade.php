...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/areas/politica/pltc.css') }}">
            ...
            <li class="dropdown">
                ...
                <div class="dropdown-content">
                    ...
                    <a href="/ApruebaTuConocimiento/Html/Areas/Informatica/Informatica.html">
                        <img src="/Assets/Iconos/Areas/informatica.png" alt="Informatica"class="nav-icon">Informática</a>
                    <a href="/ApruebaTuConocimiento/Html/Areas/Religion/Religion.html">
                        <img src="/Assets/Iconos/Areas/religion.png" alt="Religion"class="nav-icon">Religión</a>
